Hema v0.5.16-hema.7 Full Local Package

This package supersedes v0.5.16-hema.6. Do not use hema.6 because that package
missed python_embedded\python313.zip, which can cause:

Fatal Python error: Failed to import encodings module
ModuleNotFoundError: No module named 'encodings'

Included:
- python_embedded, including python313.zip and pip
- node_embedded
